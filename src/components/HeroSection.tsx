...
export function HeroSection({
  ...
  return (
    <section
      ref={sectionRef}
      id="topo"
      className="relative overflow-x-clip pt-[70px] pb-10 md:pt-[72px] md:pb-12"
    >
      <div
        aria-hidden
      ...
      <div className="container-x relative grid gap-10 lg:grid-cols-2 lg:items-start lg:gap-16">
        ...
        >
          ...
          <div className="mt-4 flex flex-wrap items-center gap-x-3 gap-y-2">
            <h1 className="inline-block font-display text-[30px] leading-[1.05] text-green-600 sm:text-[40px]">
