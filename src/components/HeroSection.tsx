  ...
  return (
    <section ref={sectionRef} id="topo" className="relative overflow-x-clip pt-[70px] pb-10 md:pt-[72px] md:pb-12">
      ...
      <div className="container-x relative grid gap-10 lg:grid-cols-2 lg:items-start lg:gap-16">
        <motion.div className="self-start lg:sticky lg:top-24" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}>
        ...
        <motion.div className="lg:pb-6" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.12, ease: [0.22, 1, 0.36, 1] }}>
          ...
          <div className="mt-8">
            <PricingCard selected={selected} onSelect={onSelect} onBuy={onBuy} addonIds={addonIds} onToggleAddon={onToggleAddon} />
          </div>
        </motion.div>
      </div>
    </section>
