          ...
          {actives.map((active) => (
            ...
            >
              <article className="relative overflow-hidden rounded-2xl">
                ...
                />
                <div className="absolute inset-x-0 bottom-0 flex h-[36%] flex-col justify-start gap-2 bg-primary-foreground/10 px-5 py-5 backdrop-blur-md lg:h-[44%]">
                  ...
                  <p className="min-h-[4.2em] text-[13px] leading-snug text-primary-foreground/90 line-clamp-3 lg:text-[16px] lg:leading-relaxed">
                    {active.description}
                  </p>
                </div>
              </article>
