          ...
          <div>
            ...
            <ul className="mx-auto mt-8 max-w-md lg:max-w-xl">
              ...
              {items.map((item) => (
                ...
                >
                  <span className="translate-x-0 lg:translate-x-24 justify-self-center text-center text-[16px] font-bold text-ink">{item.name}</span>
                  <span className="w-10 shrink-0 translate-x-0 lg:translate-x-24 text-center font-display text-[28px] font-bold leading-none text-primary">
                    {item.amount}
                  </span>
                  <span
                    aria-hidden
