  ...
  return (
    <div className="mt-8 border-t border-border pt-7">
      ...
      <Button
        ...
        className="mt-6 h-12 w-full rounded-full border-primary/30 bg-card text-sm text-ink hover:border-primary hover:bg-primary/5"
      >
      ...
      <div className="mt-7 border-y border-border">
        {details.map((detail, index) => {
          ...
          return (
            <div key={detail.title} className="border-b border-border last:border-b-0">
              <Button
                type="button"
                variant="ghost"
