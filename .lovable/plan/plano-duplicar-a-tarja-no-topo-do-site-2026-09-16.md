# Plano: duplicar a tarja no topo do site
...
## Validação
- Conferir desktop e mobile no topo da página e após rolar.
- Confirmar que não há sobreposição entre tarja, cabeçalho e conteúdo.
